...
//  LoL bio reader
//
//  Created by owajhin on 2020/11/29.
//  Copyright © 2020 OWAJHIN. All rights reserved.
//

import SwiftUI

struct ChampionQueue: View {
...
struct ChampionQueue_Previews: PreviewProvider {
    static var previews: some View {
        ChampionQueue(champions: dataStore.champions, bios: dataStore.bios)
    }
}
